...
import { TaskExecutor, evaluateImplicitCompletionRefusal, evaluateTaskDoneRefusal } from "../executor.js";
import { resetExecutorMocks } from "./executor-test-helpers.js";
import { evaluateSkipBypassTaint } from "@fusion/core";

/**
 * FNXC:ExecutorCompletionTests 2026-08-14-21:48:
 * Implicit-completion refusal is a pure exported predicate after the executor split; exercise that ownership boundary.
 */
/*
